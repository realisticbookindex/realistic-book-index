...
**3. Assign the phases.** `rule_13b_skill_path_prompt.md` against your seated lists. Out comes
Foundational, Emerging Intermediate and Intermediate. Admits nothing, declines nothing, does not
change your total.
